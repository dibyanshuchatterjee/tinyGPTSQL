...
for iter in range(max_iters):
    ...
    xb, yb = xb.to(device), yb.to(device)  # move the data to the same device as the model
...
print(decode_list(mapping=itos, l=m.generate(context, max_new_tokens=1000)[0].tolist()))
